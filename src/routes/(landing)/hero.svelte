...
>
    <div class="flex align-items:center bg:surface flex-grow:1 flex:auto flex:col px:6x r:4x">
        <div class="flex align-items:center gap:6x@sm justify-content:space-between mt:8x r:4x">
            <div
    ...
    <section class="flex flex-shrink:1 flex:auto flex:row place-items:center">
        <enhanced:img
